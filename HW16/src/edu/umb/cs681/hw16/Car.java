...
public class Car {
    ...
    public static void main(String[] args) {
    	...
    	lstCar.add(new Car("Maruti", "Swift", 2008, 27, 67000));
    	lstCar.add(new Car("Chevrolet", "Cruze", 2012, 19, 140000));
    	lstCar.add(new Car("Kia", "Seltos", 2019,20 , 90000));
    	lstCar.add(new Car("BMW", "320d", 2017, 10, 100000));
